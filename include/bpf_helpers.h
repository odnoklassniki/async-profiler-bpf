...
#define BPF_MAP(NAME, TYPE, T_KEY, T_VALUE, MAX_ENTRIES) \
struct bpf_map_def SEC("maps") NAME = { \
	.type = BPF_MAP_TYPE_ ## TYPE, \
	.key_size = sizeof(T_KEY), \
	.value_size = sizeof(T_VALUE), \
	.max_entries = MAX_ENTRIES, \
};

#define BPF_HASH_OF_MAPS(NAME, T_KEY, MAX_ENTRIES) \
struct bpf_map_def SEC("maps/hash_of_maps") NAME = { \
